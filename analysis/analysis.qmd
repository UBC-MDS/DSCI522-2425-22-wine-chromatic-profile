...
info_df = pd.DataFrame({
    "Column": wine_train.columns,
    "Non-Null Count": [wine_train[col].notnull().sum() for col in wine_train.columns],
    "Data Type": [wine_train[col].dtype for col in wine_train.columns]
})
```
...
Markdown(wine_train.describe().to_markdown())
```
...
cross_validation_results = pd.read_csv("../results/table/cross_validation.csv")
cross_validation_results = cross_validation_results.rename(
...
random_search_results = pd.read_csv("../results/table/random_search.csv")
